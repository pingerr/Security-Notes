...
- [10. 驭龙 HIDS](#10-驭龙-hids)
  - [10.1. 架构](#101-架构)
  - [10.2. 数据源](#102-数据源)
    - [10.2.1. 信息收集](#1021-信息收集)
    - [10.2.2. 行为监控](#1022-行为监控)
  - [10.3.](#103)
- [11. Hades - eBPF based HIDS](#11-hades---ebpf-based-hids)
  - [11.1. 架构](#111-架构)
  - [11.2. 核心功能](#112-核心功能)
- [12. 安全狗云眼 云主机入侵监测及安全管理平台](#12-安全狗云眼-云主机入侵监测及安全管理平台)
- [13. 总结](#13-总结)
  - [13.1. 架构](#131-架构)
  - [13.2. 数据源](#132-数据源)
    - [13.2.1. 系统信息](#1321-系统信息)
    - [13.2.2. 行为监控](#1322-行为监控)
