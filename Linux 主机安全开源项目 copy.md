...
- [Linux 主机安全开源项目](#linux-主机安全开源项目)
  ...
  - [4. Wazuh](#4-wazuh)
    - [4.1. 架构](#41-架构)
    - [4.2. 数据采集层](#42-数据采集层)
      - [4.2.1. Wazuh代理架构](#421-wazuh代理架构)
      - [4.2.2. Wazuh代理功能模块](#422-wazuh代理功能模块)
      - [4.2.3. 与Wazuh服务器通信](#423-与wazuh服务器通信)
    - [4.3. 数据分析层](#43-数据分析层)
  - [5. 驭龙 HIDS](#5-驭龙-hids)
    - [5.1. 架构](#51-架构)
    - [5.2. 数据采集层](#52-数据采集层)
      - [5.2.1. 信息收集](#521-信息收集)
      - [5.2.2. 行为监控](#522-行为监控)
  - [6. Hades - eBPF based HIDS](#6-hades---ebpf-based-hids)
    - [6.1. 架构](#61-架构)
    - [6.2. 数据采集层](#62-数据采集层)
